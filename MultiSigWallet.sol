...
contract MultiSigWallet {
    // txId is index of Transaction[] see below variable
    ...
    /* 
        uint -> index of Transaction[] => mapping
        [inner mapping] -> address is one of all owner => approved boolean
        use for keep track who approved transaction for index of Transaction array above
    */
